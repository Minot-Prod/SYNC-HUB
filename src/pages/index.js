...
<div style={{display:"flex",gap:"1rem",alignItems:"center",marginBottom:"2rem"}}>
  <img
    src="/sync-logo.png"
    alt="Sync"
    style={{height:"44px",width:"auto",filter:"drop-shadow(0 0 8px rgba(255,255,255,0.15))"}}
  />
  <div style={{opacity:0.5,fontSize:"0.95rem",fontWeight:700}}>x</div>
  <img
    src="/parlios-logo.png"
    alt="Parlios"
    style={{height:"40px",width:"auto",filter:"drop-shadow(0 0 10px rgba(255,80,80,0.35))"}}
  />
</div>
      <header
        style={{
